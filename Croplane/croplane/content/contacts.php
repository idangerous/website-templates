...
<form action="javascript:sendMessage()" method="post" id="contact_form">
  ...
  <p>
    <label>Subject:<br />
      <input style="color:#777" type="text" size="40" id="contact_subject" name="subject" value="Message From CROPLANE" readonly="readonly" />
    </label>
  </p>
  <p>
    <label>Message*:<br />
  ...
  <p>Fields marked with an asteriks(*) are required!</p>
