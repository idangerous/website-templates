<h2 class="window-heading">Contacts</h2>
...
<form name="contact" class="contact-form" action="javascript:sendMessage()" method="post">
  ...
  <p>
    <label> Subject:*<br>
      <input id="contact_subject" onkeyup="validateText('contact_subject',6)" style="color:#777" type="text" class="text" name="subject" size="30"/>
    </label>
  </p>
  <p>
    <label> Message:*<br>
